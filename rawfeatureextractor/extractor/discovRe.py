...
# Get features, including statistical and structural, for function
# Input: function
# Output: features for given function
...
def get_section(t):
    base = selector_by_name(t)
    start = get_segm_by_sel(base)
